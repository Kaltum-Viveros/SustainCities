...
$(document).ready(function() {
        ...
        template_bar += `
                    ...
                    <div id="contenedor-estilo">
                        ...
                        <div class="contenedor-intro-cs">
                            ...
                            <img src="resources/img/urbanizacion.jpg" alt="urbanizacion" class="img-cortas"/>
                        </div>

                        <div class="contenedor-caracteristicas-cs">
                            <br/> <br/>
                        ...
                        <div class="contenedor-beneficios-cs">
                            <h2>Beneficios de vivir en una comunidad sostenible</h2>
                            <div class="lista-beneficios">
                                <div class="beneficio">
                                    <img src="resources/img/icono1.png" alt="icono1" class="iconos"/> <br/>
                                    <b>Mejor calidad de vida: </b>Aire más limpio, menos ruido, más espacios verdes y una mayor sensación de bienestar.
                                </div> 
                                <div class="beneficio">
                                    <img src="resources/img/icono2.png" alt="icono2" class="iconos"/> <br/>
                                    <b>Reducción del impacto ambiental: </b>Menor consumo de energía y agua, reducción de la emisión de gases de efecto invernadero y protección de la biodiversidad. 
                                </div>
                                <div class="beneficio">
                                    <img src="resources/img/icono3.png" alt="icono3" class="iconos"/> <br/>
                                    <b>Mayor cohesión social:</b>Fomento de la participación ciudadana, la colaboración y el sentido de comunidad.
                                    
                                </div>
                                <div class="beneficio">
                                    <img src="resources/img/icono4.png" alt="icono4" class="iconos"/> <br/>
                                    <b>Desarrollo económico a largo plazo: </b>Atracción de inversiones y creación de empleos en sectores sostenibles
                                </div>
                            </div>
    ...
    $(document).on('click', '#comoAportar', function() {
        ...
        success: function(){
                let template_bar = '';
                template_bar += `
                            <div class="contenedor-ca"> 
                            
                                <div class="contenedor-ca-text"> 
                                ...
                                <div class="contenedor-ca-img"> 
                                    <img src="resources/img/transporte-sostenible.jpg" alt="transporte sostenible"/>
                                    <img src="resources/img/inclusiva.jpg" alt="arquitectura inclusiva"/>
                                    <img src="resources/img/resilencia-desastres.jpg" alt=""/>
                                    <img src="resources/img/vivienda-sostenible.jpg" alt="vivienda sostenible"/>
                                    <img src="resources/img/educar.jpg" alt="educar y sensibilizar"/>
                                    <img src="resources/img/inovacion-tecnologica.jpg" alt="inovacion tecnologica"/>
                                    <img src="resources/img/consumo-responsable.jpg" alt=""/>
                                    <img src="resources/img/energia-limpia.jpg" alt="energia limpia"/>
                                </div>
